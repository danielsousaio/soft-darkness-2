"""
Django settings for soft_darkness_2 project.
...
ROOT_URLCONF = 'soft_darkness_2.urls'
...
WSGI_APPLICATION = 'soft_darkness_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_darkness_2 API",
    "DESCRIPTION": "API documentation for soft_darkness_2 App",
    "VERSION": "v1",
}
